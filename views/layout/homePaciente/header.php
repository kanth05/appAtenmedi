...
<body class="layout-top-nav" style="height: auto;">
      ...
      <div class="modal-content">
        <div class="modal-footer p-3">
          ...
          <div class="float-right pl-4">
            <a href="<?=base_url?>paciente/logout" class="btn btn-default btn-sm">
                Si
            </a>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-success navbar-dark">
      ...
      <ul class="navbar-nav container-fluid">
        <li class="nav-item d-sm-inline-block text-center">
          <h3>
            <?php if($_SESSION['identityOp']['chat'] == 'no'):?>
              <a class="nav-link text-light" data-toggle="modal" data-target="#myModal">
                <span>
    ...
    <div class="content-wrapper pt-3" style = "min-height: 594.359px">
